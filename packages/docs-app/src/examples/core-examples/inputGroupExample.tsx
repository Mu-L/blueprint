...
export const InputGroupExample: React.FC<ExampleProps> = props => {
    ...
    const inputGroupProps: InputGroupProps = { disabled, large, small, readOnly, intent };
...
const PasswordInputGroup: React.FC<InputGroupProps> = props => {
    ...
    const handleLockClick = React.useCallback(() => setShowPassword(!showPassword), [showPassword]);
